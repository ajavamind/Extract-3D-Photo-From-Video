...
rem 4V full size remove -resize x1080 option
rem 4V resized to vertical 1080 pixels, no alignment
...
magick montage %1 %2 %3 %4 -resize x1080 -geometry +0+0 -tile 2x2 %5_1080_2x2.jpg
